        ...
        <Row id="signin-row">
            ...
            <Col sm={12} md={6} id="signin-col-2">
                <form id="signin-form" onSubmit={(e) => { FormHandler(e) }}>
                    ...
                    {ps === 'weak'?<p id ="ps" class='wps' ref={passref}><strong>{ ps }</strong></p>:<p id ="ps" class='sps' ref={passref}><strong>{ ps }</strong></p>}
                    
                      
                    <input type='password' ref={textinput} onChange={(e) => { passwordStrengthHandler(e.target.value) }} placeholder="Password" ></input>
                    
                    <input type='password' ref={textinput} onChange={(e) => { setconfirmPassword(e.target.value) }} placeholder="Confirm password" />
